  ...
  (() => {
    ...
    r.VantaBase = class {
      constructor(e = {}) {
        ...
        (a('resize', this.resize),
          ...
          this.options.mouseControls &&
            (a('scroll', this.windowMouseMoveWrapper), a('mousemove', this.windowMouseMoveWrapper)),
          this.options.touchControls &&
            (a('touchstart', this.windowTouchWrapper), a('touchmove', this.windowTouchWrapper)),
      ...
      applyCanvasStyles(e, t = {}) {
        (Object.assign(e.style, { position: 'absolute', zIndex: 0, top: 0, left: 0, background: '' }),
      ...
      windowMouseMoveWrapper(e) {
        ...
        s >= 0 &&
          ...
          s <= t.width &&
          i <= t.height &&
          ((this.mouseX = s), (this.mouseY = i), this.options.mouseEase || this.triggerMouseMove(s, i));
      }
      ...
      triggerMouseMove(e, t) {
        (void 0 === e &&
          ...
          this.uniforms &&
            ((this.uniforms.iMouse.value.x = e / this.scale), (this.uniforms.iMouse.value.y = t / this.scale)));
    ...
    class p extends a {
      ...
      initP5(e) {
        ...
        (i.parent(t.el),
          t.applyCanvasStyles(e.canvas, { background: s(t.options.backgroundColor) }),
          (t.p5renderer = i),
          (t.p5canvas = e.canvas),
          (t.p5 = e));
      }
    ...
    class d extends p {
      static initClass() {
        ((this.prototype.p5 = !0), (this.prototype.defaultOptions = { color: 9016910, backgroundColor: 8738 }));
      }
      constructor(e) {
        ((l = e.p5 || l), super(e));
      }
              ...
              (t.translate(-100, -100),
                ...
                (function () {
                  ...
                  for (let e = 0; e < a.length; e++)
                    l.Vector.dist(a[e].prev, a[e].pos) < 10 && t.line(a[e].prev.x, a[e].prev.y, a[e].pos.x, a[e].pos.y);
                })(),
                (c += 0.002));
            }));
        });
