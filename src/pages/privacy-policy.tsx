      ...
      <main className="max-w-5xl mx-auto px-6 py-20 text-secondary-700">
        ...
        <section className="space-y-8 leading-relaxed">
          <div>
            ...
            <p>
              Halvestor Limited (“Halvestor”, “we”, “our”, “us”) operates the
              Halvestor paper-trading application and website. This policy
          ...
          <div>
            ...
            <ul className="list-disc pl-6">
              ...
              <li>
                Address: Flat 36, Clay Alto, Exhibition Way, Wembley, London
                HA9 0GS
              </li>
          ...
          <div>
            ...
            <p>
              Name, e-mail address, encrypted password, and basic technical
              usage data. We do not collect payment data, identity documents,
          ...
          <div>
            ...
            <p>
              To operate and secure the service, improve performance, send
              optional updates, and report anonymised usage statistics.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Data is stored on secure UK/EEA servers, encrypted in transit,
          ...
          <div>
            ...
            <p>
              ...
              object to processing of your data. Requests can be sent to
